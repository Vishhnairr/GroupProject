                                ...
                                while (true) { //interaction in All users
                                    ...
                                    if (userSelected == null) {
                                        ...
                                        while (true) { // interactions if chose a specific user in all users
                                            ...
                                            paneFour.setDropDownLabel("What do you want " +
                                                            ...
                                                            new MessageHistoryEditor.MessageHistoryListener() {
                                                                ...
                                                                public void onMessagesDeleted(
                                                                    ...
                                                                    if (!finalHistory.isEmpty()) {
                                                                        ...
                                                                        clients.output.println(
                                                                                remainingMessages.size());
                                                                        for (int i = 0; i <
                                                                                remainingMessages.size(); i++) {
                                                                            clients.output.println(
                                                            ...
                                                            new MessageHistoryEditor.MessageHistoryListener() {
                                                                ...
                                                                public void onMessagesDeleted(
                                                                    ...
                                                                    if (!finalHistory.isEmpty()) {
                                                                        ...
                                                                        clients.output.println(
                                                                                remainingMessages.size());
                                                                        for (int i = 0; i < remainingMessages.size();
                                                                             i++) {
                                                                            clients.output.println(
                                                                                    remainingMessages.get(i));
                                                                        }
