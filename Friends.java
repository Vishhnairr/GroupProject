...
//     */
    ...
    public synchronized boolean makeFriendRequest() {
        ...
        try {
            File friendRequestFile = new File("User_" +
                    this.friendUsername + "_FriendRequest.txt");
        ...
        try {
            FileOutputStream fos = new FileOutputStream("User_" +
                    this.friendUsername + "_FriendRequest.txt", true);
    ...
    public synchronized boolean rejectFriendRequest() {
        ...
        try {
            File friendRequest = new File("User_" +
                    this.user.getUsername() + "_FriendRequest.txt");
    ...
    public synchronized boolean addFriend() {
        ...
        try {
            File friendFile = new File("User_" +
                    this.user.getUsername() + "_Friends.txt");
        ...
        try {
            File friendsFile = new File("User_" +
                    this.friendUsername + "_Friends.txt");
...
//     */
    public synchronized boolean blockUser() {
        ...
        if (!removeFriendRequestFromUser(this.user.getUsername(),
                this.friendUsername)) {
            return false;  // If the operation fails, return false
        }

        // Remove any friend requests sent to the target user
        if (!removeFriendRequestFromUser(this.friendUsername,
        ...
        try {
            File blockFile = new File("User_" +
                    this.user.getUsername() + "_Block.txt");
            if (!blockFile.exists()) {
    ...
    public synchronized boolean removeFriendRequestFromUser(String ownerUsername, String targetUsername) {
        ArrayList<String> requests = new ArrayList<>();
        try {
            File requestFile = new File("User_" +
                    ownerUsername + "_FriendRequest.txt");
    ...
    public synchronized String viewProfile() {
        ...
        if (friend.getProfileView()) {
            ...
            try {
                File friendsFriendFile = new File("User_" +
                        this.friendUsername + "_Friends.txt");
