...
public class GeneralSelectionPane {
    ...
    public void createSelectionPane() {
        ...
        addTitlePanel(frame, "Boiler Town"); // Set the
        // appropriate title for the context
    ...
    private void addTitlePanel(JFrame aFrame, String titleText) {
        JPanel titlePanel = new JPanel();
        titlePanel.setLayout(new FlowLayout(FlowLayout.CENTER));
        titlePanel.setBorder(BorderFactory.createEmptyBorder(10, 0,
                20, 0)); // Top and bottom margins
