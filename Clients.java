                    ...
                    if (!responses.equals(";")) { //Log in successfully
                        ...
                        while (breakCheck) { //Interactions after Log In
                            ...
                            if (secondChose == null) {
                                    ...
                                    if (userSelected == null) {
                                        ...
                                        while (true) { // interactions if chose a specific user in all users
                                            ...
                                            if (thirdChose == null) {
                                                ...
                                                clients.output.println(thirdChose); //pass thirdChose (6)
                                                String result = clients.input.readLine(); //receive result of making
                                                // a friend request {4}
                                                ...
                                                clients.output.println(thirdChose); //pass thirdChose (6)
                                                String result = clients.input.readLine(); //receive result of
                                                // blocking a user {4}
                                                ...
                                                String content = JOptionPane.showInputDialog("Please enter what " +
                                                        "you want to send: ");
                                                ...
                                                if (content == null) {
                                                    ...
                                                    String result = clients.input.readLine(); //receive the result of
                                                    // sending message {4}
                                                ...
                                                String messageCount = clients.input.readLine(); //receive the count
                                                // of messages {4}
                                ...
                                second.addTextBoxes("Please enter the user you want to search " +
                                        "(Enter a username)");
                                        ...
                                        while (true) { //Interactions in search user
                                            ...
                                            if (thirdChose == null) {
                                                ...
                                                if (thirdChose.equals("View profile")) {
                                                    ...
                                                    String countFile = clients.input.readLine(); //receive length of
                                                    // file {3}
                                                    ...
                                                    clients.output.println(thirdChose); //pass thirdChose (6)
                                                    String resultRequest = clients.input.readLine(); //receive result
                                                    // of making a friend request {3}
                                                    ...
                                                    clients.output.println(thirdChose); //pass thirdChose (6)
                                                    String resultBlock = clients.input.readLine(); //receive result
                                                    // of blocking a user {3}
                                                    ...
                                                    if (content == null) {
                                                        ...
                                                        clients.output.println(thirdChose); //pass thirdChose (6)
                                                        clients.output.println(content); //pass the content of message
                                                        // (7)
                                                        String resultSend = clients.input.readLine(); //receive the
                                                        // result of sending message {3}
                                                    ...
                                                    String messageCount = clients.input.readLine(); //receive the
                                                    // count of messages {3}
                                                    int messages = Integer.parseInt(messageCount);
                                    ...
                                    if (pickedFriend == null) {
                                        ...
                                        while (true) { //Interactions after chose a specific friend
                                            ...
                                            if (thirdChose == null) {
                                                ...
                                                clients.output.println(thirdChose); //pass thirdChose (6)
                                                String friendFile = clients.input.readLine(); //receive length of
                                                // file {4}
                                                ...
                                                String messageCount = clients.input.readLine(); //receive the count of
                                                // messages {4}
                                                int messages = Integer.parseInt(messageCount);
                                ...
                                while (true) { //Interactions in friend request
                                    ...
                                    if (pickedRequest == null) {
                                        ...
                                        while (true) { //Interactions in view friend request after chose a specific
                                            // request
