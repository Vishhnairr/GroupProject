                ...
                switch (userChoice) {
                    case 1: {  // user creates account
                        ...
                        do {
                            ...
                            if (!isValid)
                                System.out.println("Invalid bio. Please ensure it is between 20 to 40 characters.");
                        } while (!isValid);
                        ...
                        do {
                            ...
                            if (!isValid)
                                System.out.println("Invalid password. Please ensure it is at least 4 characters long.");
                        } while (!isValid);
